...
![[Pasted image 20260304143539.png]]
...
**Result:** The forbidden topic appeared as a recurring theme in the generated examples (e.g., repeated references to the topic across many different questions). Then, I just asked two questions about the words themselves (i.e. "What is WORD? And what is WORD?").
